module.exports = function(grunt) {
  ...
  //matchers
  var matchers = {
    indexFiles: ['web/*.+(php|txt|ico|html|xml)','web/.htaccess']
  };
  ...
  grunt.registerTask('dev', ['clean:build','jshint', 'bower', 'copy', 'ngtemplates:build', 'imagemin', 'less', 'rjs:write','ngtemplates:signup','requirejs:dev','rjs:write','requirejs:devsignup','clean:buildArtifacts']);
  ...
  grunt.registerTask('dev:signup', ['jshint', 'bower', 'copy','ngtemplates:signup', 'less', 'rjs:write','requirejs:devsignup', 'clean:buildArtifacts']);
};
